...
${P}+ -- --=[${G} metasploit6 install ${P}    ]
${P}+ -- --=[${G} code by issam iso   ${P}    ]
${P}+ -- --=[${G} facebook.com/issamiso4 ${P} ]
${P}+ -- --=[${G} version 6 Without root ${P} ]
"
printf "${C}[*]${W} Do you want to install metasploit Y/n : "
read cum 
case $cum in
"y")
echo -e "${B}[*]${W} start download ...."
cd ~
cd $HOME
install
;;
